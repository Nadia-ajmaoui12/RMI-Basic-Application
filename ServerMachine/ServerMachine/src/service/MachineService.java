...
@Override
public List<Machine> getMachinesBySalle(String salleCode) throws RemoteException {
    Session session = null;
    Transaction tx = null;
    List<Machine> machines = null;
    try {
        ...
        criteria.createAlias("salle", "s");
        criteria.add(Restrictions.eq("s.code", salleCode));
        machines = criteria.list();
